...
Ответ: Pull-модель (от англ. pull - тянуть) предполагает, что система мониторинга сама запрашивает данные у источников. То есть, система мониторит только те устройства, которые были выбраны для мониторинга, и запрашивает у них данные только тогда, когда это необходимо.  
...
![1](https://github.com/plusvaldis/mnt-homeworks-ansible/blob/MNT-video/10-monitoring-02-systems/img/1.png)
...
![2](https://github.com/plusvaldis/mnt-homeworks-ansible/blob/MNT-video/10-monitoring-02-systems/img/2.png)
#
...
![3](https://github.com/plusvaldis/mnt-homeworks-ansible/blob/MNT-video/10-monitoring-02-systems/img/3.png)
